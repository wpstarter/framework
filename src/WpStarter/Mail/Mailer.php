...
use WpStarter\Contracts\Mail\MailQueue as MailQueueContract;
use WpStarter\Contracts\Queue\Factory as QueueContract;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @param  string  $name
     * @param  \WpStarter\Contracts\View\Factory  $views
     ...
     *
     * @param  string  $queue
     * @param  \WpStarter\Contracts\Mail\Mailable  $view
     * @return mixed
     */
     ...
     *
     * @return \WpStarter\Contracts\View\Factory
     */
