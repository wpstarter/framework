...
namespace WpStarter\Redis\Connectors;

use WpStarter\Contracts\Redis\Connector;
use WpStarter\Redis\Connections\PhpRedisClusterConnection;
use WpStarter\Redis\Connections\PhpRedisConnection;
use WpStarter\Support\Arr;
use WpStarter\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \WpStarter\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \WpStarter\Redis\Connections\PhpRedisClusterConnection
     */
