...
use WpStarter\Redis\Connections\Connection;
use WpStarter\Redis\Connectors\PhpRedisConnector;
use WpStarter\Redis\Connectors\PredisConnector;
use WpStarter\Support\Arr;
use WpStarter\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \WpStarter\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param  \WpStarter\Redis\Connections\Connection  $connection
     * @param  string  $name
     * @return \WpStarter\Redis\Connections\Connection
     */
     ...
     *
     * @return \WpStarter\Contracts\Redis\Connector
     */
