...
use WpStarter\Testing\Constraints\CountInDatabase;
use WpStarter\Testing\Constraints\HasInDatabase;
use WpStarter\Testing\Constraints\NotSoftDeletedInDatabase;
use WpStarter\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  \WpStarter\Database\Eloquent\Model|string  $table
     * @param  array  $data
    ...
    protected function isSoftDeletableModel($model)
    {
        return $model instanceof Model
            && in_array(SoftDeletes::class, ws_class_uses_recursive($model));
    }
