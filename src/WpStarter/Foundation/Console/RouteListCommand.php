...
class RouteListCommand extends Command
{
    ...
    {
        $routes = ws_collect($this->router->getRoutes())->map(function ($route) {
    ...
    {
        return ws_collect($this->router->gatherRouteMiddleware($route))->map(function ($middleware) {
