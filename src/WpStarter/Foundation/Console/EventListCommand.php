...
class EventListCommand extends Command
{
    ...
    protected function getEvents()
    {
        ...
        return ws_collect($events)->map(function ($listeners, $event) {
            return ['Event' => $event, 'Listeners' => implode(PHP_EOL, $listeners)];
        })->sortBy('ws_event')->values()->toArray();
    }
    ...
    protected function filterEvents(array $events)
    {
        ...
        return ws_collect($events)->filter(function ($listeners, $event) use ($eventName) {
