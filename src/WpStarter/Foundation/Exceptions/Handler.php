...
use WpStarter\Contracts\Debug\ExceptionHandler as ExceptionHandlerContract;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \WpStarter\Foundation\Exceptions\ReportableHandler[]
     */
     ...
     * @return \WpStarter\Foundation\Exceptions\ReportableHandler
     */
     ...
     *
     * @param  \WpStarter\Http\Request  $request
     * @param  \WpStarter\Auth\AuthenticationException  $exception
     * @return \Symfony\Component\HttpFoundation\Response
     */
    protected function unauthenticated($request, AuthenticationException $exception)
    {
        return $this->shouldReturnJson($request, $exception)
                    ...
                    : ws_redirect()->guest($exception->redirectTo() ?? ws_route('login'));
    }

    /**
     * Create a response object from the given validation exception.
     *
     * @param  \WpStarter\Validation\ValidationException  $e
     * @param  \WpStarter\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \WpStarter\Http\Request  $request
     * @param  \WpStarter\Validation\ValidationException  $exception
    ...
    {
        try {
            return ws_config('app.debug') && class_exists(Whoops::class)
                        ? $this->renderExceptionWithWhoops($e)
                        : $this->renderExceptionWithSymfony($e, ws_config('app.debug'));
        } catch (Exception $e) {
    ...
    {
        try {
            return ws_app(HandlerInterface::class);
    ...
    protected function renderHttpException(HttpExceptionInterface $e)
    {
        ...
        if (ws_view()->exists($view = $this->getHttpExceptionView($e))) {
    ...
    /**
     * Map the given exception into an WpStarter response.
     *
    ...
    protected function convertExceptionToArray(Throwable $e)
    {
        return ws_config('app.debug') ? [
            ...
            'file' => $e->getFile(),
            'line' => $e->getLine(),
            'trace' => ws_collect($e->getTrace())->map(function ($trace) {
