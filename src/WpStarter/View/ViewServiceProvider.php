...
use WpStarter\View\Engines\FileEngine;
...
class ViewServiceProvider extends ServiceProvider
{
     ...
     *
     * @param  \WpStarter\View\Engines\EngineResolver  $resolver
    ...
    public function registerBladeCompiler()
    {
        $this->app->singleton('blade.compiler', function ($app) {
            return ws_tap(new BladeCompiler($app['files'], $app['config']['view.compiled']), function ($blade) {
