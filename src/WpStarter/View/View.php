...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @var \WpStarter\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \WpStarter\View\Factory  $factory
     * @param  \WpStarter\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     * @return void
