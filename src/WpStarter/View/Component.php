...
abstract class Component
{
     ...
     *
     * @var \WpStarter\View\ComponentAttributeBag
     */
    public $attributes;
     ...
     *
     * @return \WpStarter\Contracts\View\View|\WpStarter\Contracts\Support\Htmlable|\Closure|string
     */
     ...
     *
     * @param  \WpStarter\Contracts\View\Factory  $factory
    ...
    protected function extractPublicProperties()
    {
        ...
        if (! isset(static::$propertyCache[$class])) {
            ...
            static::$propertyCache[$class] = ws_collect($reflection->getProperties(ReflectionProperty::IS_PUBLIC))
    ...
    protected function extractPublicMethods()
    {
        ...
        if (! isset(static::$methodCache[$class])) {
            ...
            static::$methodCache[$class] = ws_collect($reflection->getMethods(ReflectionMethod::IS_PUBLIC))
     ...
     *
     * @param  string  $method
     * @return \WpStarter\View\InvokableComponentVariable
     */
     ...
     *
     * @param  array  $attributes
     * @return \WpStarter\View\ComponentAttributeBag
     */
