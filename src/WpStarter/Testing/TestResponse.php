...
use WpStarter\Testing\Fluent\AssertableJson;
use LogicException;
use Symfony\Component\HttpFoundation\StreamedResponse;

/**
 * @mixin \WpStarter\Http\Response
 */
...
EOF;
    ...
    public function assertCookie($cookieName, $value = null, $encrypted = true, $unserialize = false)
    {
        ...
        $actual = $encrypted
            ? CookieValuePrefix::remove(ws_app('encrypter')->decrypt($cookieValue, $unserialize))
            : $cookieValue;
    ...
    public function assertSeeText($value, $escape = true)
    {
        ...
        ws_tap(strip_tags($this->getContent()), function ($content) use ($values) {
            foreach ($values as $value) {
     ...
     *
     * @return \WpStarter\Testing\AssertableJsonString
     *
     * @throws \Throwable
     */
     ...
     *
     * @param  \WpStarter\Support\Collection  $exceptions
     * @return $this
     */
