...
class CompiledRouteCollection extends AbstractRouteCollection
{
     ...
     *
     * @var \WpStarter\Routing\RouteCollection|null
     */
    protected $routes;
    ...
    {
        $attributes = ws_collect($this->attributes)->first(function (array $attributes) use ($action) {
    ...
    {
        return ws_collect($this->attributes)
    ...
    {
        return ws_collect($this->getRoutes())
