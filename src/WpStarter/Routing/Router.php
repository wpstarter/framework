...
use WpStarter\Contracts\Routing\BindingRegistrar;
use WpStarter\Contracts\Routing\Registrar as RegistrarContract;
...
use WpStarter\Routing\Events\RouteMatched;
...
/**
 * @mixin \WpStarter\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \WpStarter\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     *
     * @var \WpStarter\Routing\Route|null
     */
    protected $current;
    ...
    {
        return $this->any($uri, '\WpStarter\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\WpStarter\Routing\ViewController')
                ->setDefaults([
                    'view' => $view,
                    'data' => $data,
     ...
     * @param  array  $options
     * @return \WpStarter\Routing\PendingResourceRegistration
     */
    ...
    public function gatherRouteMiddleware(Route $route)
    {
        ...
        $excluded = ws_collect($route->excludedMiddleware())->map(function ($name) {
     ...
     *
     * @return \WpStarter\Routing\RouteCollectionInterface
     */
