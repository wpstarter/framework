...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     *
     * @var \WpStarter\Routing\RouteUrlGenerator|null
     */
     ...
     *
     * @param  \WpStarter\Routing\RouteCollectionInterface  $routes
     ...
     * @return string
     *
     * @throws \WpStarter\Routing\Exceptions\UrlGenerationException
     */
    public function toRoute($route, $parameters, $absolute)
    {
        $parameters = ws_collect(Arr::wrap($parameters))->map(function ($value, $key) use ($route) {
     ...
     *
     * @return \WpStarter\Routing\RouteUrlGenerator
     */
    ...
    public function setRequest(Request $request)
    {
        ...
        ws_tap(ws_optional($this->routeGenerator)->defaultParameters ?: [], function ($defaults) {
