...
namespace WpStarter\Broadcasting\Broadcasters;
...
abstract class Broadcaster implements BroadcasterContract
{
     ...
     *
     * @var \WpStarter\Contracts\Routing\BindingRegistrar
     */
     ...
     *
     * @param  \WpStarter\Contracts\Broadcasting\HasBroadcastChannel|string  $channel
    ...
    protected function extractAuthParameters($pattern, $channel, $callback)
    {
        ...
        return ws_collect($this->extractChannelKeys($pattern, $channel))->reject(function ($value, $key) {
     ...
     *
     * @return \WpStarter\Contracts\Routing\BindingRegistrar
     */
