...
use Ably\AblyRest;
use Closure;
use WpStarter\Broadcasting\Broadcasters\AblyBroadcaster;
use WpStarter\Broadcasting\Broadcasters\LogBroadcaster;
use WpStarter\Broadcasting\Broadcasters\NullBroadcaster;
use WpStarter\Broadcasting\Broadcasters\PusherBroadcaster;
use WpStarter\Broadcasting\Broadcasters\RedisBroadcaster;
use WpStarter\Contracts\Broadcasting\Factory as FactoryContract;
...
/**
 * @mixin \WpStarter\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  \WpStarter\Contracts\Container\Container  $app
     * @return void
     */
    ...
    public function routes(array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\WpStarter\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
