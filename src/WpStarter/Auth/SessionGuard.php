...
use WpStarter\Auth\Events\Attempting;
use WpStarter\Auth\Events\Authenticated;
use WpStarter\Auth\Events\CurrentDeviceLogout;
use WpStarter\Auth\Events\Failed;
use WpStarter\Auth\Events\Login;
use WpStarter\Auth\Events\Logout;
use WpStarter\Auth\Events\OtherDeviceLogout;
use WpStarter\Auth\Events\Validated;
use WpStarter\Contracts\Auth\Authenticatable as AuthenticatableContract;
use WpStarter\Contracts\Auth\StatefulGuard;
use WpStarter\Contracts\Auth\SupportsBasicAuth;
use WpStarter\Contracts\Auth\UserProvider;
use WpStarter\Contracts\Cookie\QueueingFactory as CookieJar;
use WpStarter\Contracts\Events\Dispatcher;
use WpStarter\Contracts\Session\Session;
...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     *
     * @var \WpStarter\Contracts\Session\Session
     */
    protected $session;

    /**
     * The WpStarter cookie creator service.
     *
     * @var \WpStarter\Contracts\Cookie\QueueingFactory
     */
    protected $cookie;
     ...
     * @param  \WpStarter\Support\Timebox|null  $timebox
     * @return void
     */
     ...
     *
     * @param  \WpStarter\Auth\Recaller  $recaller
     * @return mixed
     */
     ...
     *
     * @return \WpStarter\Auth\Recaller|null
     */
    ...
    protected function rehashUserPassword($password, $attribute)
    {
        ...
        return ws_tap($this->user()->forceFill([
     ...
     *
     * @return \WpStarter\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @param  \WpStarter\Contracts\Cookie\QueueingFactory  $cookie
     * @return void
     */
     ...
     *
     * @return \WpStarter\Support\Timebox
     */
