...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \WpStarter\Contracts\Translation\Translator
     */
     ...
     *
     * @var \WpStarter\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \WpStarter\Support\MessageBag
     */
    protected $messages;
    ...
    {
        ws_throw_if($this->invalid(), $this->exception, $this);
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \WpStarter\Contracts\Validation\Rule  $rule
     * @return void
     */
    ...
    {
        return ws_collect($this->messages()->toArray())->map(function ($message, $key) {
    ...
    {
        $rules = ws_collect($rules)->mapWithKeys(function ($value, $key) {
     ...
     *
     * @param  string  $attribute
     * @return \WpStarter\Support\Fluent|array|mixed
     */
     ...
     * @return \WpStarter\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \WpStarter\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \WpStarter\Contracts\Translation\Translator
     */
