 ...
 * @method static \WpStarter\Wordpress\Routing\Route any(string $uri, array|string|callable|null $action = null)
 * @method static \WpStarter\Wordpress\Routing\Route|null current()
 * @method static \WpStarter\Wordpress\Routing\Route delete(string $uri, array|string|callable|null $action = null)
 * @method static \WpStarter\Wordpress\Routing\Route fallback(array|string|callable|null $action = null)
 * @method static \WpStarter\Wordpress\Routing\Route get(string $uri, array|string|callable|null $action = null)
 * @method static \WpStarter\Wordpress\Routing\Route|null getCurrentRoute()
 * @method static \WpStarter\Routing\RouteCollectionInterface getRoutes()
 * @method static \WpStarter\Wordpress\Routing\Route match(array|string $methods, string $uri, array|string|callable|null $action = null)
 * @method static \WpStarter\Wordpress\Routing\Route options(string $uri, array|string|callable|null $action = null)
 * @method static \WpStarter\Wordpress\Routing\Route patch(string $uri, array|string|callable|null $action = null)
 * @method static \WpStarter\Wordpress\Routing\Route permanentRedirect(string $uri, string $destination)
 * @method static \WpStarter\Wordpress\Routing\Route post(string $uri, array|string|callable|null $action = null)
 * @method static \WpStarter\Wordpress\Routing\Route put(string $uri, array|string|callable|null $action = null)
 * @method static \WpStarter\Wordpress\Routing\Route redirect(string $uri, string $destination, int $status = 302)
 * @method static \WpStarter\Wordpress\Routing\Route substituteBindings(\WpStarter\Support\Facades\Route $route)
 * @method static \WpStarter\Wordpress\Routing\Route view(string $uri, string $view, array $data = [], int|array $status = 200, array $headers = [])
 ...
 *
 * @see \WpStarter\Wordpress\Routing\Router
 */
