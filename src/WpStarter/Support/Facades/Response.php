...
/**
 * @method static \WpStarter\Http\JsonResponse json(string|array $data = [], int $status = 200, array $headers = [], int $options = 0)
 * @method static \WpStarter\Http\JsonResponse jsonp(string $callback, string|array $data = [], int $status = 200, array $headers = [], int $options = 0)
 ...
 * @method static \WpStarter\Http\RedirectResponse redirectToAction(string $action, mixed $parameters = [], int $status = 302, array $headers = [])
 ...
 * @method static \WpStarter\Http\RedirectResponse redirectToRoute(string $route, mixed $parameters = [], int $status = 302, array $headers = [])
 * @method static \WpStarter\Http\Response make(array|string $content = '', int $status = 200, array $headers = [])
 * @method static \WpStarter\Http\Response noContent($status = 204, array $headers = [])
 * @method static \WpStarter\Http\Response view(string $view, array $data = [], int $status = 200, array $headers = [])
 ...
 *
 * @see \WpStarter\Contracts\Routing\ResponseFactory
 */
