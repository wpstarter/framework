 ...
 * @method static \WpStarter\Http\Request capture()
 * @method static \WpStarter\Http\Request createFrom(\WpStarter\Http\Request $from, \WpStarter\Http\Request|null $to = null)
 * @method static \WpStarter\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \WpStarter\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 * @method static \WpStarter\Http\Request instance()
 * @method static \WpStarter\Http\Request merge(array $input)
 * @method static \WpStarter\Http\Request replace(array $input)
 * @method static \WpStarter\Http\Request setJson(\Symfony\Component\HttpFoundation\ParameterBag $json)
 * @method static \WpStarter\Http\Request setRouteResolver(\Closure $callback)
 * @method static \WpStarter\Http\Request setUserResolver(\Closure $callback)
 * @method static \WpStarter\Http\UploadedFile|\WpStarter\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static \WpStarter\Routing\Route|object|string route(string|null $param = null, string|null $default = null)
 * @method static \WpStarter\Session\Store session()
 * @method static \WpStarter\Session\Store|null getSession()
 ...
 * @method static void setLaravelSession(\WpStarter\Contracts\Session\Session $session)
 *
 * @see \WpStarter\Http\Request
 */
