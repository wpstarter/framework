...
/**
 * @method static \WpStarter\Contracts\Foundation\Application loadEnvironmentFrom(string $file)
 * @method static \WpStarter\Support\ServiceProvider register(\WpStarter\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \WpStarter\Support\ServiceProvider resolveProvider(string $provider)
 * @method static array getProviders(\WpStarter\Support\ServiceProvider|string $provider)
 ...
 *
 * @see \WpStarter\Contracts\Foundation\Application
 */
