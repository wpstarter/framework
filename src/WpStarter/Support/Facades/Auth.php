 ...
 * @method static \WpStarter\Contracts\Auth\Authenticatable loginUsingId(mixed $id, bool $remember = false)
 ...
 * @method static void setUser(\WpStarter\Contracts\Auth\Authenticatable $user)
 * @method static void shouldUse(string $name);
 *
 * @see \WpStarter\Auth\AuthManager
 * @see \WpStarter\Contracts\Auth\Factory
 * @see \WpStarter\Contracts\Auth\Guard
 * @see \WpStarter\Contracts\Auth\StatefulGuard
 */
