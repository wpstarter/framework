...
/**
 * @method static \WpStarter\Cache\TaggedCache tags(array|mixed $names)
 * @method static \WpStarter\Contracts\Cache\Lock lock(string $name, int $seconds = 0, mixed $owner = null)
