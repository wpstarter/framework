...
trait InteractsWithInput
{
    ...
    {
        return ws_collect(is_array($key) ? $this->only($key) : $this->input($key));
    }
    ...
    public function only($keys)
    {
        ...
        foreach (is_array($keys) ? $keys : func_get_args() as $key) {
            $value = ws_data_get($input, $key, $placeholder);
     ...
     * @param  string|null  $key
     * @param  mixed  $default
     * @return \WpStarter\Http\UploadedFile|\WpStarter\Http\UploadedFile[]|array|null
     */
