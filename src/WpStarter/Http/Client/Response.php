...
class Response implements ArrayAccess
{
    ...
    {
        return ws_optional($this->transferStats)->getEffectiveUri();
    }
    ...
    {
        return ws_optional($this->transferStats)->getHandlerStats() ?? [];
    }
     ...
     *
     * @return \WpStarter\Http\Client\RequestException|null
     */
     ...
     * @return $this
     *
     * @throws \WpStarter\Http\Client\RequestException
     */
