...
trait ConditionallyLoadsAttributes
{
     ...
     * @param  mixed  $value
     * @param  mixed  $default
     * @return \WpStarter\Http\Resources\MissingValue|mixed
     */
    protected function when($condition, $value, $default = null)
    {
        ...
        return func_num_args() === 3 ? ws_value($default) : new MissingValue;
    }
     ...
     *
     * @param  mixed  $value
     * @return \WpStarter\Http\Resources\MergeValue|mixed
     */
    ...
    {
        return $condition ? new MergeValue(ws_value($value)) : new MissingValue;
    }
     ...
     * @return \WpStarter\Http\Resources\MergeValue
     */
