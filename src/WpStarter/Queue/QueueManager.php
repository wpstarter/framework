...
use Closure;
use WpStarter\Contracts\Queue\Factory as FactoryContract;
use WpStarter\Contracts\Queue\Monitor as MonitorContract;
...
class QueueManager implements FactoryContract, MonitorContract
{
     ...
     *
     * @param  string  $driver
     * @return \WpStarter\Queue\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
