...
use WpStarter\Contracts\Queue\Factory as QueueManager;
use WpStarter\Database\DetectsLostConnections;
...
use WpStarter\Queue\Events\Looping;
...
class Worker
{
     ...
     * @param  \WpStarter\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \WpStarter\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     *
     * @param  \WpStarter\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     * @return \WpStarter\Contracts\Queue\Job|null
     */
     ...
     *
     * @param  \WpStarter\Contracts\Queue\Job  $job
     * @return \WpStarter\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @return \WpStarter\Queue\QueueManager
     */
