...
use WpStarter\Contracts\Queue\ClearableQueue;
use WpStarter\Contracts\Queue\Queue as QueueContract;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \WpStarter\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string|null  $queue
     * @return \WpStarter\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \WpStarter\Queue\Jobs\DatabaseJobRecord  $job
     * @return \WpStarter\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  string  $queue
     * @param  \WpStarter\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
