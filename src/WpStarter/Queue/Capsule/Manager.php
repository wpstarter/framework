...
namespace WpStarter\Queue\Capsule;

use WpStarter\Container\Container;
use WpStarter\Queue\QueueManager;
use WpStarter\Queue\QueueServiceProvider;
use WpStarter\Support\Traits\CapsuleManagerTrait;

/**
 * @mixin \WpStarter\Queue\QueueManager
 * @mixin \WpStarter\Contracts\Queue\Queue
 */
class Manager
{
     ...
     *
     * @var \WpStarter\Queue\QueueManager
     */
    protected $manager;
