...
class Event
{
     ...
     *
     * @param  \WpStarter\Console\Scheduling\EventMutex  $mutex
    ...
    protected function runCommandInForeground(Container $container)
    {
        try {
            ...
            $this->exitCode = Process::fromShellCommandline(
                $this->buildCommand(), ws_base_path(), null, null, null
            )->run();
    ...
    protected function runCommandInBackground(Container $container)
    {
        try {
            ...
            Process::fromShellCommandline($this->buildCommand(), ws_base_path(), null, null, null)->run();
