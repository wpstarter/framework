...
use Aws\S3\S3Client;
use Closure;
use WpStarter\Contracts\Filesystem\Factory as FactoryContract;
...
/**
 * @mixin \WpStarter\Contracts\Filesystem\Filesystem
 */
class FilesystemManager implements FactoryContract
{
     ...
     *
     * @param  array  $config
     * @return \WpStarter\Contracts\Filesystem\Cloud
     */
