...
use Closure;
use WpStarter\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use WpStarter\Contracts\Filesystem\FileExistsException as ContractFileExistsException;
use WpStarter\Contracts\Filesystem\FileNotFoundException as ContractFileNotFoundException;
use WpStarter\Contracts\Filesystem\Filesystem as FilesystemContract;
use WpStarter\Http\File;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param  string  $path
     * @param  \Psr\Http\Message\StreamInterface|\WpStarter\Http\File|\WpStarter\Http\UploadedFile|string|resource  $contents
     * @param  mixed  $options
     * @return bool
     */
     ...
     *
     * @param  string  $path
     * @param  \WpStarter\Http\File|\WpStarter\Http\UploadedFile|string  $file
     * @param  mixed  $options
     * @return string|false
     */
