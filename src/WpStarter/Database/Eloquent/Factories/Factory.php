...
abstract class Factory
{
     ...
     * @param  \WpStarter\Support\Collection|null  $states
     * @param  \WpStarter\Support\Collection|null  $has
     * @param  \WpStarter\Support\Collection|null  $for
     * @param  \WpStarter\Support\Collection|null  $afterMaking
     * @param  \WpStarter\Support\Collection|null  $afterCreating
    ...
    public function createMany(iterable $records)
    {
        return new EloquentCollection(
            ws_collect($records)->map(function ($record) {
     ...
     * @param  array  $attributes
     * @param  \WpStarter\Database\Eloquent\Model|null  $parent
     * @return \WpStarter\Database\Eloquent\Collection|\WpStarter\Database\Eloquent\Model
     */
    public function create($attributes = [], ?Model $parent = null)
    {
        ...
        if ($results instanceof Model) {
            $this->store(ws_collect([$results]));

            $this->callAfterCreating(ws_collect([$results]), $parent);
        } else {
            $this->store($results);
     ...
     *
     * @param  \WpStarter\Support\Collection  $results
     * @return void
     */
    ...
    public function make($attributes = [], ?Model $parent = null)
    {
        ...
        if ($this->count === null) {
            return ws_tap($this->makeInstance($parent), function ($instance) {
                $this->callAfterMaking(ws_collect([$instance]));
            });
        }
    ...
    {
        return ws_collect($definition)->map(function ($attribute, $key) use (&$definition) {
     ...
     *
     * @param  \WpStarter\Support\Collection  $instances
     * @return void
     */
