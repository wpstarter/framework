...
use WpStarter\Database\Eloquent\Relations\Concerns\InteractsWithPivotTable;
...
class BelongsToMany extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \WpStarter\Support\Collection|\WpStarter\Database\Eloquent\Model
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \WpStarter\Database\Eloquent\Model|\WpStarter\Database\Eloquent\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \WpStarter\Database\Eloquent\Model|\WpStarter\Database\Eloquent\Collection
     *
    ...
    protected function aliasedPivotColumns()
    {
        ...
        return ws_collect(array_merge($defaults, $this->pivotColumns))->map(function ($column) {
     ...
     *
     * @param  \WpStarter\Support\Collection|array  $models
     * @param  array  $pivotAttributes
     * @return array
     */
