...
namespace WpStarter\Database\Migrations;
...
class Migrator
{
     ...
     *
     * @var \WpStarter\Database\Migrations\MigrationRepositoryInterface
     */
    ...
    protected function resetMigrations(array $migrations, array $paths, $pretend = false)
    {
        ...
        $migrations = ws_collect($migrations)->map(function ($m) {
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return ws_tap($callback(), function () use ($previousConnection) {
     ...
     *
     * @return \WpStarter\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \WpStarter\Filesystem\Filesystem
     */
     ...
     *
     * @param  \WpStarter\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
