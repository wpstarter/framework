...
use WpStarter\Database\Concerns\ExplainsQueries;
...
class Builder
{
     ...
     *
     * @var \WpStarter\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \WpStarter\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     * @param  \WpStarter\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \WpStarter\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\WpStarter\Database\Query\Builder|\WpStarter\Database\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\WpStarter\Database\Query\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Closure|\WpStarter\Database\Query\Builder|string  $table
     ...
     *
     * @param  \WpStarter\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \WpStarter\Database\Query\JoinClause
     */
     ...
     *
     * @param  string  $column
     * @param  \WpStarter\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|\WpStarter\Database\Query\Expression  $column
     * @param  array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @param  \WpStarter\Database\Query\Expression|string  $column
     * @param  string  $operator
     ...
     *
     * @param  \Closure|\WpStarter\Database\Eloquent\Builder|\WpStarter\Database\Query\Builder|\WpStarter\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\WpStarter\Database\Query\Builder|\WpStarter\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \WpStarter\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return $this
     */
    ...
    {
        return ws_collect($this->onceWithColumns(Arr::wrap($columns), function () {
     ...
     * @param  int|null  $page
     * @return \WpStarter\Contracts\Pagination\LengthAwarePaginator
     */
    public function paginate($perPage = 15, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        $results = $total ? $this->forPage($page, $perPage)->get($columns) : ws_collect();
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \WpStarter\Contracts\Pagination\Paginator
     */
    ...
    protected function ensureOrderForCursorPagination($shouldReverse = false)
    {
        ...
        return ws_collect($this->orders ?? $this->unionOrders ?? [])->filter(function ($order) {
    ...
    protected function stripTableForPluck($column)
    {
        ...
        return ws_last(preg_split('~'.$separator.'~i', $column));
    }
    ...
    public function upsert(array $values, $uniqueBy, $update = null)
    {
        ...
        $bindings = $this->cleanBindings(array_merge(
            ...
            ws_collect($update)->reject(function ($value, $key) {
                return is_int($key);
            })->all()
        ));
     ...
     *
     * @param  mixed  $value
     * @return \WpStarter\Database\Query\Expression
     */
     ...
     *
     * @return \WpStarter\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \WpStarter\Database\Query\Grammars\Grammar
     */
