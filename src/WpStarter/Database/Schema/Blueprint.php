...
class Blueprint
{
     ...
     *
     * @var \WpStarter\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
    ...
    {
        return ws_collect($this->commands)->filter(function ($command) use ($names) {
    ...
    {
        return ws_collect($this->commands)->contains(function ($command) {
     ...
     *
     * @param  string  $column
     * @return \WpStarter\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  \WpStarter\Database\Schema\ColumnDefinition  $definition
     * @return \WpStarter\Database\Schema\ColumnDefinition
     */
    ...
    {
        return ! is_null(ws_collect($this->getAddedColumns())->first(function ($column) {
    ...
    public function autoIncrementingStartingValues()
    {
        ...
        return ws_collect($this->getAddedColumns())->mapWithKeys(function ($column) {
            return $column->autoIncrement === true
