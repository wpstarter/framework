...
class SQLiteGrammar extends Grammar
{
    ...
    protected function addForeignKeys(Blueprint $blueprint)
    {
        ...
        return ws_collect($foreigns)->reduce(function ($sql, $foreign) {
     ...
     *
     * @param  \WpStarter\Support\Fluent  $foreign
     * @return string
     */
    ...
    public function compileAdd(Blueprint $blueprint, Fluent $command)
    {
        ...
        return ws_collect($columns)->reject(function ($column) {
     ...
     *
     * @param  \WpStarter\Support\Fluent  $column
     * @return string
     */
