...
use WpStarter\Database\Console\Migrations\MigrateMakeCommand;
...
use WpStarter\Database\Console\Migrations\StatusCommand;
use WpStarter\Database\Migrations\DatabaseMigrationRepository;
