...
class DatabaseManager implements ConnectionResolverInterface
{
     ...
     *
     * @var \WpStarter\Database\Connectors\ConnectionFactory
     */
    protected $factory;
     ...
     * @param  \WpStarter\Database\Connectors\ConnectionFactory  $factory
     * @return void
     */
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return ws_tap($callback(), function () use ($previousName) {
