...
use WpStarter\Contracts\Hashing\Hasher;
...
use WpStarter\Validation\DatabasePresenceVerifierInterface;
use WpStarter\Validation\Rules\Exists;
use WpStarter\Validation\Rules\Unique;
use WpStarter\Validation\ValidationData;
...
class ValidationValidatorTest extends TestCase
{
    ...
    public function testCustomExceptionMustExtendValidationException()
    {
        ...
        $this->expectExceptionMessage('Exception [RuntimeException] is invalid. It must extend [WpStarter\Validation\ValidationException].');
