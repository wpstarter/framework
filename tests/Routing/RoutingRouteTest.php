...
use WpStarter\Routing\RouteGroup;
...
class RoutingRouteTest extends TestCase
{
    ...
    public function testModelBindingWithNullReturn()
    {
        ...
        $this->expectExceptionMessage('No query results for model [WpStarter\Tests\Routing\RouteModelBindingNullStub].');
    ...
    public function testInvalidActionException()
    {
        ...
        $this->expectExceptionMessage('Invalid route action: [WpStarter\Tests\Routing\RouteTestControllerStub].');
    ...
    public function testRouteCanMiddlewareCanBeAssigned()
    {
        ...
        $this->assertEquals([
            'foo',
            'can:create,WpStarter\Routing\Route',
        ], $route->middleware());
