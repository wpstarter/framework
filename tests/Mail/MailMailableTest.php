...
class MailMailableTest extends TestCase
{
    public function testMailableSetsRecipientsCorrectly()
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->to(ws_collect([new MailableTestUserStub, new MailableTestUserStub]));
        $this->assertEquals([
    ...
    public function testMailableSetsCcRecipientsCorrectly()
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->cc(ws_collect([new MailableTestUserStub, new MailableTestUserStub]));
        $this->assertEquals([
            ['name' => 'Taylor Otwell', 'address' => 'taylor@laravel.com'],
            ['name' => 'Taylor Otwell', 'address' => 'taylor@laravel.com'],
        ], $mailable->cc);
    ...
    public function testMailableSetsBccRecipientsCorrectly()
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->bcc(ws_collect([new MailableTestUserStub, new MailableTestUserStub]));
        $this->assertEquals([
            ['name' => 'Taylor Otwell', 'address' => 'taylor@laravel.com'],
            ['name' => 'Taylor Otwell', 'address' => 'taylor@laravel.com'],
        ], $mailable->bcc);
    ...
    public function testMailableSetsReplyToCorrectly()
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->replyTo(ws_collect([new MailableTestUserStub, new MailableTestUserStub]));
        $this->assertEquals([
            ['name' => 'Taylor Otwell', 'address' => 'taylor@laravel.com'],
            ['name' => 'Taylor Otwell', 'address' => 'taylor@laravel.com'],
        ], $mailable->replyTo);
    ...
    public function testMailableSetsFromCorrectly()
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->from(ws_collect([new MailableTestUserStub, new MailableTestUserStub]));
        $this->assertEquals([
            ['name' => 'Taylor Otwell', 'address' => 'taylor@laravel.com'],
            ['name' => 'Taylor Otwell', 'address' => 'taylor@laravel.com'],
        ], $mailable->from);
