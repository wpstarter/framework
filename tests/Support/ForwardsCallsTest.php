...
class ForwardsCallsTest extends TestCase
{
    ...
    public function testMissingForwardedCallThrowsCorrectError()
    {
        ...
        $this->expectExceptionMessage('Call to undefined method WpStarter\Tests\Support\ForwardsCallsOne::missingMethod()');
    ...
    {
        $this->expectException(BadMethodCallException::class);
        $this->expectExceptionMessage('Call to undefined method WpStarter\Tests\Support\ForwardsCallsOne::this1_shouldWork_too()');
    ...
    public function testNonForwardedErrorIsNotTamperedWith()
    {
        ...
        $this->expectExceptionMessage('Call to undefined method WpStarter\Tests\Support\ForwardsCallsBase::missingMethod()');
    ...
    {
        $this->expectException(BadMethodCallException::class);
        $this->expectExceptionMessage('Call to undefined method WpStarter\Tests\Support\ForwardsCallsOne::test()');
