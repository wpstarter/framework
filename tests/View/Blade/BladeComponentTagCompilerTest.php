...
class BladeComponentTagCompilerTest extends AbstractBladeTestCase
{
    ...
    public function testSlotsWithDynamicAttributesCanBeCompiled()
    {
        ...
        $this->assertSame("@slot('foo', null, ['class' => \WpStarter\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\$classes)]) \n".' @endslot', trim($result));
    }
...
'@endComponentClass##END-COMPONENT-CLASS##</div>', trim($result));
    ...
    public function testDataCamelCasing()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\Tests\View\Blade\TestProfileComponent', 'profile', ['userId' => '1'])
...
<?php \$component->withAttributes([':title' => 'user.name']); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    ...
    public function testColonAttributesIsEscapedIfStrings()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\Tests\View\Blade\TestProfileComponent', 'profile', [])
<?php \$component->withAttributes(['src' => \WpStarter\View\Compilers\BladeCompiler::sanitizeComponentAttribute('foo')]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    }
    ...
    public function testColonNestedComponentParsing()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\Tests\View\Blade\TestAlertComponent', 'foo:alert', [])
<?php \$component->withAttributes([]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    }
...
'@endComponentClass##END-COMPONENT-CLASS##</div>', trim($result));
    ...
    public function testComponentsCanBeCompiledWithHyphenAttributes()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\Tests\View\Blade\TestAlertComponent', 'alert', [])
...
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    ...
    public function testSelfClosingComponentsCanBeCompiledWithDataAndAttributes()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\Tests\View\Blade\TestAlertComponent', 'alert', ['title' => 'foo'])
...
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    ...
    public function testComponentCanReceiveAttributeBag()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\Tests\View\Blade\TestProfileComponent', 'profile', [])
<?php \$component->withAttributes(['class' => 'bar','attributes' => \WpStarter\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\$attributes),'wire:model' => 'foo']); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    }
    ...
    public function testSelfClosingComponentCanReceiveAttributeBag()
    {
        ...
        $this->assertSame("<div>##BEGIN-COMPONENT-CLASS##@component('WpStarter\Tests\View\Blade\TestAlertComponent', 'alert', ['title' => 'foo'])
<?php \$component->withAttributes(['class' => 'bar','attributes' => \WpStarter\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\$attributes->merge(['class' => 'test'])),'wire:model' => 'foo']); ?>\n".
            '@endComponentClass##END-COMPONENT-CLASS##</div>', trim($result));
    }
...
'@endComponentClass##END-COMPONENT-CLASS##Words', trim($result));
    ...
    public function testSelfClosingComponentsCanBeCompiledWithBoundData()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\Tests\View\Blade\TestAlertComponent', 'alert', ['title' => \$title])
...
<?php \$component->withAttributes([]); ?>
 @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    ...
    public function testClasslessComponents()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\View\AnonymousComponent', 'anonymous-component', ['view' => 'components.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php \$component->withAttributes(['name' => \WpStarter\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    }
    ...
    public function testClasslessComponentsWithIndexView()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\View\AnonymousComponent', 'anonymous-component', ['view' => 'components.anonymous-component.index','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php \$component->withAttributes(['name' => \WpStarter\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    }
    ...
    public function testPackagesClasslessComponents()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('WpStarter\View\AnonymousComponent', 'package::anonymous-component', ['view' => 'package::components.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php \$component->withAttributes(['name' => \WpStarter\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    }
