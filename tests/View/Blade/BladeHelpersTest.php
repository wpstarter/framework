...
class BladeHelpersTest extends AbstractBladeTestCase
{
    ...
    {
        $this->assertSame('<?php echo ws_csrf_field(); ?>', $this->compiler->compileString('@csrf'));
        $this->assertSame('<?php echo ws_method_field(\'patch\'); ?>', $this->compiler->compileString("@method('patch')"));
