...
use WpStarter\Container\EntryNotFoundException;
use WpStarter\Contracts\Container\BindingResolutionException;
use WpStarter\Contracts\Container\CircularDependencyException;
...
class ContainerTest extends TestCase
{
    ...
    public function testInternalClassWithDefaultParameters()
    {
        ...
        $this->expectExceptionMessage('Unresolvable dependency resolving [Parameter #0 [ <required> $first ]] in class WpStarter\Tests\Container\ContainerMixedPrimitiveStub');
    ...
    {
        $this->expectException(BindingResolutionException::class);
        $this->expectExceptionMessage('Target [WpStarter\Tests\Container\IContainerContractStub] is not instantiable.');
    ...
    {
        $this->expectException(BindingResolutionException::class);
        $this->expectExceptionMessage('Target [WpStarter\Tests\Container\IContainerContractStub] is not instantiable while building [WpStarter\Tests\Container\ContainerDependentStub].');
