...
use WpStarter\Database\Schema\Builder;
use WpStarter\Database\Schema\Grammars\MySqlGrammar;
use WpStarter\Database\Schema\Grammars\PostgresGrammar;
use WpStarter\Database\Schema\Grammars\SQLiteGrammar;
use WpStarter\Database\Schema\Grammars\SqlServerGrammar;
use Mockery as m;
...
class DatabaseSchemaBlueprintTest extends TestCase
{
    ...
    public function testGenerateRelationshipColumnWithIncrementalModel()
    {
        $base = new Blueprint('posts', function ($table) {
            $table->foreignIdFor('WpStarter\Foundation\Auth\User');
        });
