...
class DatabaseEloquentModelTest extends TestCase
{
    ...
    {
        $model = $this->getMockBuilder('WpStarter\Tests\Database\EloquentDateModelStub')->onlyMethods(['getDateFormat'])->getMock();
    ...
    public function testModelObserversCanBeAttachedToModels()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: WpStarter\Tests\Database\EloquentModelStub', EloquentTestObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: WpStarter\Tests\Database\EloquentModelStub', EloquentTestObserverStub::class.'@saved');
    ...
    public function testModelObserversCanBeAttachedToModelsThroughCallingObserveMethodOnlyOnce()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: WpStarter\Tests\Database\EloquentModelStub', EloquentTestAnotherObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: WpStarter\Tests\Database\EloquentModelStub', EloquentTestAnotherObserverStub::class.'@saved');
    ...
    public function testWithoutEventDispatcher()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: WpStarter\Tests\Database\EloquentModelSaveStub', EloquentTestObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: WpStarter\Tests\Database\EloquentModelSaveStub', EloquentTestObserverStub::class.'@saved');
        ...
        $events->shouldReceive('until')->once()->with('eloquent.saving: WpStarter\Tests\Database\EloquentModelSaveStub', $model);
        $events->shouldReceive('dispatch')->once()->with('eloquent.saved: WpStarter\Tests\Database\EloquentModelSaveStub', $model);
    ...
    public function testGetModelAttributeMethodThrowsExceptionIfNotRelation()
    {
        ...
        $this->expectExceptionMessage('WpStarter\Tests\Database\EloquentModelStub::incorrectRelationStub must return a relationship instance.');
    ...
    public function testModelAttributeCastingFailsOnUnencodableData()
    {
        ...
        $this->expectExceptionMessage('Unable to encode attribute [objectAttribute] for model [WpStarter\Tests\Database\EloquentModelCastingStub] to JSON: Malformed UTF-8 characters, possibly incorrectly encoded.');
