...
use WpStarter\Database\Eloquent\BroadcastableModelEventOccurred;
use WpStarter\Database\Eloquent\BroadcastsEvents;
    ...
    public function testBasicBroadcasting()
    {
        ...
        Event::assertDispatched(function (BroadcastableModelEventOccurred $event) {
            return $event->model instanceof TestEloquentBroadcastUser
                    ...
                    && $event->broadcastOn()[0]->name == "private-WpStarter.Tests.Integration.Database.TestEloquentBroadcastUser.{$event->model->id}";
        });
    }
    ...
    public function testBroadcastingOnModelTrashing()
    {
        ...
        Event::assertDispatched(function (BroadcastableModelEventOccurred $event) {
            return $event->model instanceof SoftDeletableTestEloquentBroadcastUser
                ...
                && $event->broadcastOn()[0]->name == "private-WpStarter.Tests.Integration.Database.SoftDeletableTestEloquentBroadcastUser.{$event->model->id}";
        });
    }
    ...
    public function testBroadcastingForSpecificEventsOnly()
    {
        ...
        Event::assertDispatched(function (BroadcastableModelEventOccurred $event) {
            return $event->model instanceof TestEloquentBroadcastUserOnSpecificEventsOnly
                ...
                && $event->broadcastOn()[0]->name == "private-WpStarter.Tests.Integration.Database.TestEloquentBroadcastUserOnSpecificEventsOnly.{$event->model->id}";
        });
