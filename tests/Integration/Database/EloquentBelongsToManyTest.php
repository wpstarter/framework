...
namespace WpStarter\Tests\Integration\Database\EloquentBelongsToManyTest;
...
class EloquentBelongsToManyTest extends DatabaseTestCase
{
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [WpStarter\Tests\Integration\Database\EloquentBelongsToManyTest\Tag] 10');
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [WpStarter\Tests\Integration\Database\EloquentBelongsToManyTest\Tag] 10, 11');
