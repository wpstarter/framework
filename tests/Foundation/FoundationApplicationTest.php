...
use WpStarter\Foundation\Bootstrap\RegisterFacades;
...
class FoundationApplicationTest extends TestCase
{
    ...
    public function testMethodAfterLoadingEnvironmentAddsClosure()
    {
        ...
        $this->assertArrayHasKey(0, $app['events']->getListeners('bootstrapped: WpStarter\Foundation\Bootstrap\LoadEnvironmentVariables'));
    }
    ...
    public function testBeforeBootstrappingAddsClosure()
    {
        ...
        $this->assertArrayHasKey(0, $app['events']->getListeners('bootstrapping: WpStarter\Foundation\Bootstrap\RegisterFacades'));
    }
    ...
    public function testAfterBootstrappingAddsClosure()
    {
        ...
        $this->assertArrayHasKey(0, $app['events']->getListeners('bootstrapped: WpStarter\Foundation\Bootstrap\RegisterFacades'));
    }
